import { referenceCategories, referenceProducts } from './referenceShop'
...
export const fallbackContent = {
  settings: {
    ...
    aboutText:
      'Milan selectionne, conseille et installe les accessoires qui transforment vraiment votre vehicule : multimedia, carrosserie, eclairage, jantes, confort et finitions premium.',
    aboutImage: '/assets/category-bodykit.webp',
    footerText:
      'Specialistes des accessoires automobile, pieces de carrosserie, activation CarPlay et lumiere d ambiance.',
    seoTitle: 'Accessoires auto premium au Maroc | Milan Automobile Accessoires',
    seoDescription:
      'Milan Automobile Accessoires selectionne et installe des accessoires premium pour votre voiture a Tanger et partout au Maroc.',
  },
